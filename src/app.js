...
<header>
  <h1 class="text-center lightGrey-text italic">Hey! 👋 I'm <b class="lightPurple-text">Daz</b></h1>
  <h2 class="display-2 text-center grey-text">I make stuff for the web ...</h2>

  <nav class="nav align-center">
  <button class="blue"><i class="fa-brands fa-github"></i> GitHub</button>
  <button class="blue"><i class="fa-brands fa-linkedin"></i> LinkedIn</button>
  </nav>
...
<main id="gallery">
  <h2 class="display-3 grey-text">Here's  some stuff I've made ...</h2>
...
const Project = props => html`
  <li class="card">
    <header><h3 class="text-center">${props.title}</h3></header>
    <main>
